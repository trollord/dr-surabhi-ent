          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {conditions.map((c) => (
              ...
              >
                ...
                <h2 className="font-serif text-xl font-bold text-[#1e293b] mb-2 group-hover:text-[#0c4a6e] transition-colors">
                  {c.title}
                </h2>
                <p className="text-sm text-[#64748b] leading-relaxed mb-4">{c.description}</p>
                <span className="inline-flex items-center gap-1 text-sm font-semibold text-[#0c4a6e] group-hover:gap-2 transition-all">
                  Explore &rarr;
                </span>
              </Link>
            ))}
            ...
            {/* CTA card */}
            <div className="bg-[#0c4a6e] rounded-2xl p-8 flex flex-col justify-center text-center">
              ...
              <Link
                href="/contact"
                className="inline-block px-5 py-2.5 rounded-full bg-[#0c9b85] text-white text-sm font-semibold hover:bg-[#14b8a6] transition-colors mx-auto"
              >
                Book Consultation
              </Link>
            </div>
