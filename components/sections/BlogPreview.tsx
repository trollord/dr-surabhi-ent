...
const posts = [
  ...
  },
  {
    ...
    categoryColor: "text-[#1a2a45] bg-[#0f1a2e]",
  },
  {
    ...
    categoryColor: "text-[#C9A96E] bg-[#faf5ff]",
  },
];
    ...
    <section className="py-20 bg-[#1a2a45]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-sm font-semibold text-[#0f1a2e] hover:gap-3 transition-all"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {posts.map((post) => (
            <article
              key={post.slug}
              className="bg-[#1a2a45] border border-[#243355] rounded-xl shadow-sm card-hover flex flex-col overflow-hidden"
            >
