      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="relative flex justify-center lg:justify-start">
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-4 -right-4 sm:-right-6 bg-[#C9A96E] text-white rounded-xl px-4 py-3 shadow-lg text-center">
          ...
          <div>
            ...
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-[#FAFAFA] mb-6">
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 text-[#0f1a2e] font-semibold hover:gap-3 transition-all"
            >
              Read Full Bio
